  ...
  return (
    <div className={SidebarCSS.main}>
      ...
      <div className={SidebarCSS.sidebar_box}>
        <Link onClick={handleClick1} className={SidebarCSS.links} to="student_verification" >
        <div className={is1Active ?SidebarCSS.sidebar_item +" "+ SidebarCSS.active:SidebarCSS.sidebar_item}>
        ...
        <Link onClick={handleClick2} className={SidebarCSS.links} to="recruiter_verification" >
        <div className={is2Active ?SidebarCSS.sidebar_item +" "+ SidebarCSS.active:SidebarCSS.sidebar_item}>
          <div className={SidebarCSS.hoverbox}>
            <RiBuilding2Fill />
            <span className={SidebarCSS.sidebar_text}>
        ...
        <Link onClick={handleClick3} className={SidebarCSS.links} to="recruiter_credentials" >
        <div className={is3Active ?SidebarCSS.sidebar_item +" "+ SidebarCSS.active:SidebarCSS.sidebar_item}>
          <div className={SidebarCSS.hoverbox}>
            <MdComputer />
            <span className={SidebarCSS.sidebar_text}>
